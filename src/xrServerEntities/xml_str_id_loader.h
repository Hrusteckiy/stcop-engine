...
TEMPLATE_SPECIALIZATION
typename void	CSXML_IdToIndex::InitInternal (bool crashOnFail /*= true*/, bool ignoreMissingEndTagError /*= false*/)
{
	VERIFY(!m_pItemDataVector);
	T_INIT::InitXmlIdToIndex();
	...
	for (int it=0; it<count; ++it)	
	{
		...
		uiXml->Load				(CONFIG_PATH, "gameplay", xml_file_full.c_str(), crashOnFail);
